...
Our work closes this gap: we demonstrate that the difference between standard thresholds and CRC-calibrated thresholds corresponds to a 23--87 percentage-point improvement in fire detection rate.
