...
\caption{Safety vs.\ efficiency for all six configurations.  \textbf{Top:} coverage (safety), where only CRC and three-way methods achieve ${\ge}95\%$.  \textbf{Bottom:} set size (efficiency), where U-Net+CRC is the optimal operating point.}
